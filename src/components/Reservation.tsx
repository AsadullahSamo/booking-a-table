...
const Reservation = () => {
    ...
    const handleNumberofPeopleClicked = (e) => {
        if (selectedPeopleSlot) {
            selectedPeopleSlot.style.backgroundColor = '';
            selectedPeopleSlot.style.color = '';
        }
        ...
        // Update the currently selected element
        setSelectedPeopleSlot(e.target);
    }
        ...
        <>
            <div className='pt-24 w-96 h-[100%] bg-gray-100 m-auto'>
                ...
                <ul className="flex gap-5 justify-center mb-10">
                    <li onClick={handleNumberofPeopleClicked} className="font-semibold text-[18px] hover:bg-[#e0e0e0] hover:transition-all duration-500 hover:cursor-pointer hover:border hover:border-[#f4ce14] hover:rounded-full px-3"> 1 - 2 </li>
                    <li onClick={handleNumberofPeopleClicked} className="font-semibold text-[18px] hover:bg-[#e0e0e0] hover:transition-all duration-500 hover:cursor-pointer hover:border hover:border-[#f4ce14] hover:rounded-full px-3"> 3 - 4 </li>
                    <li onClick={handleNumberofPeopleClicked} className="font-semibold text-[18px] hover:bg-[#e0e0e0] hover:transition-all duration-500 hover:cursor-pointer hover:border hover:border-[#f4ce14] hover:rounded-full px-3"> 5 </li>
                    <li onClick={handleNumberofPeopleClicked} className="font-semibold text-[18px] hover:bg-[#e0e0e0] hover:transition-all duration-500 hover:cursor-pointer hover:border hover:border-[#f4ce14] hover:rounded-full px-3"> 6 </li>
                    <li onClick={handleNumberofPeopleClicked} className="font-semibold text-[18px] hover:bg-[#e0e0e0] hover:transition-all duration-500 hover:cursor-pointer hover:border hover:border-[#f4ce14] hover:rounded-full px-3"> 7 </li>
                </ul>
